        ...
        <div className="container">
          ...
          <div className="slider-budges">
            <div className="box">
              ...
              <input type="range-1" className="range-2" min="0" max="100" id="slider-1"/>
              <input type="range-1" className="range-3" min="0" max="100" id="slider-1"/>
              </div>
              </form>
              </div>
            </div>
          ...
          <div className="navigation-pills-container">
            ...
            <div className="both-pills">
              <div className="horizontal-pill">
                <Horizontalpillnav />
              </div>
